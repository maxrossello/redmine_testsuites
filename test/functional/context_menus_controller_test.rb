...
class ContextMenusControllerTest < Redmine::ControllerTest
  def test_context_menu_one_issue_should_link_to_issue_path
    ...
    assert_select 'a.icon-del[href*=?]', 'ids%5B%5D=1', :text => I18n.t(:button_delete_object, object_name: I18n.t(:label_issue).downcase)
  ...
  def test_context_menu_multiple_issues_should_link_to_bulk_update_issues_path
    ...
    assert_select 'a.icon-del[href*=?]', 'ids%5B%5D=1&ids%5B%5D=2', :text => I18n.t(:button_delete_object, object_name: I18n.t(:label_issue_plural).downcase)
  ...
  def test_context_menu_multiple_issues_of_same_project
    ...
    assert_select 'a.icon-del[href*=?]', ids, :text => I18n.t(:button_delete_object, object_name: I18n.t(:label_issue_plural).downcase)
