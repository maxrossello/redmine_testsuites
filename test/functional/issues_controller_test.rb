...
class IssuesControllerTest < Redmine::ControllerTest
  ...
  def test_index_should_include_new_issue_link
    ...
    assert_select '#content a.new-issue[href="/projects/ecookbook/issues/new"]', :text => I18n.t(:label_issue_new)
  end
  ...
  def test_index_should_include_new_issue_tab_when_enabled
    with_settings :new_item_menu_tab => '1' do
      ...
      assert_select '#main-menu a.new-issue[href="/projects/ecookbook/issues/new"]', :text => I18n.t(:label_issue_new)
    end
  end
