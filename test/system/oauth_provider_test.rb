...
class OauthProviderSystemTest < ApplicationSystemTestCase
  test 'application creation and authorization' do
    ...
    with_settings rest_api_enabled: 1 do
      ...
      #check 'View Issues'
      check I18n.t :permission_view_issues
      click_button 'Create'
    ...
    find 'p code', visible: true, text: /#{I18n.t(:permission_view_issues)}/
    ...
    with_settings rest_api_enabled: 1 do
      ...
      find '.oauth-permissions', visible: true, text: /#{I18n.t(:permission_view_issues)}/
      #find '.oauth-permissions', visible: true, text: /View project/
      find '.oauth-permissions', visible: true, text: /#{I18n.t(:permission_view_project)}/
