...
class RoutingPluginsTest < Redmine::RoutingTest
  def setup
    ...
    Redmine::PluginLoader.directory = Rails.root.join('plugins/redmine_testsuites/test/fixtures/plugins')
    Redmine::Plugin.directory = Rails.root.join('plugins/redmine_testsuites/test/fixtures/plugins')
